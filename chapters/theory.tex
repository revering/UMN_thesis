...
Quarks carry electric charge and weak hypercharge, which allow them to interact with photons, W, and Z bosons, as well as color charge, which allows them to interact with gluons. 
...
\begin{figure}[htpb]
	\includegraphics[width=1.\textwidth]{figures/smRatePreds.pdf}
	\centering
...
\begin{figure}[htpb]
	...
	\caption[Visible, x-ray, and gravitational lensing images of the bullet cluster]{ A combined optical, gravitational, and x-ray image of the bullet cluster. The optical image shows the location of the Galaxies, while the x-ray image present the location of the intracluster gas and the gravitational lensing data shows the total mass distribution. Lensing data shows that the mass distribution remains with the galaxies and exhibits no signs of slowing from the collision, while the intracluster gas is greatly slowed and produces a visible shock front in the smaller of the two clusters. X-ray: NASA/CXC/CfA/ M.Markevitch et al.; Lensing Map: NASA/STScI; ESO WFI; Magellan/U.Arizona/ D.Clowe et al. Optical image: NASA/STScI; Magellan/U.Arizona/D.Clowe et al.}
	\label{fig:bullet}
\end{figure}
...
By measuring the perturbation of the CMB and decomposing it into spherical harmonics, the angular power spectrum can be created, shown in \Cref{fig:CMBpowerSpectrum}.
...
Initially, anisotropies are present from quantum fluctuations which expanded to cosmological scales during inflation, the period shortly after the big bang when the universe expanded exponentially.
...
In \dbrem, a dark matter particle is emitted from a muon after the muon exchanges a photon with a nucleus in the detector (\Cref{fig:dbrem_feyn}).
...
The invariant mass of di-muon pairs produced in the DY process where selection requirements are only applied for the detector acceptance is shown in \Cref{fig:dySpectrum}, as well as the energy of the individual muons produced. 
