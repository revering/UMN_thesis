...
The invariant mass of di-muon pairs produced in the DY process with minimal selection requirements is shown in \Cref{fig:diMuonSpectrum}, as well as the energy of the individual muons produced. 
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/cms_diMuonSpectrum.jpg}
	\hspace{0.01\textwidth}
	\includegraphics[width=0.45\textwidth]{figures/dyMuonEnergySpectrum.jpg}
	\caption[DY Process Di-muon Invariant Mass and Outgoing Muon Energy]{The simulated di-muon invariant mass spectrum for DY events in CMS with minimal selection criteria.}
