...
Due to the relatively large uncertainty in standalone muon reconstruction (see \Cref{fig:staDEoverE}), the requirement that the standalone muon have $<$40$\%$ of the probe track energy still results in $\mathcal{O}(10^{5})$ selected DY muons.
