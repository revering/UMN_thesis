...
Following the methods in \cite{Cowan_2011}, this cumulative probability $F(q_0,\mu')$ of this distribution can be approximated (becoming exact in the large sample limit) as 
\begin{equation}
