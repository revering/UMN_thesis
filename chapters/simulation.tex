...
For the pileup calculation, the nominal total inelastic cross section of $\sigma_pp=$\SI{69.2}{\milli\barn} was used with an overall uncertainty of $\pm4.6\%$\cite{pileupCx}.
