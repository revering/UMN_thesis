...
The strong magnetic field provided by the solenoid reduces the necessary detector size to measure particle momentum and increase the precision of the measured \pt. 
...
Because of the high rate requirement, the L1 trigger uses dedicated hardware to make trigger decisions using simplified versions of the event reconstruction.
