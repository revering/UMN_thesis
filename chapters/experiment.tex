...
A drawing of one half-disk in the tracker endcap is shown in \Cref{fig:trackerEndcap}, along with a close-up of a single pixel module.
...
\begin{figure}[ht]
    \includegraphics[width=\textwidth]{figures/cscInteractionExample.pdf}
    \centering
