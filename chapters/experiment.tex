...
A schematic drawing of a transverse slice through CMS, showing the typical behavior of several particle types, is presented in \Cref{fig:cmsSlice}.
...
The layout of a transverse slice of the CMS tracker is shown in \Cref{fig:cmsTracker}.
...
A drawing of one half-disk in the tracker endcap is shown in \Cref{fig:fpixExample}, along with a close-up of a single pixel module.
...
The masked regions, shown in \Cref{fig:EEmasks}, remove roughly 2$\%$ of the total ECAL area.
...
The HCAL endcaps have 17 active layers consisting of plastic scintillator and \SI{8}{\centi\meter} thick brass absorber, covering 1.4$<\eta<$2.4 and extending to $\lvert z \rvert<$ \SI{5.6}{\meter}, with a total radiation length near 200 X$_0$. 
...
To record the energy deposited in the sampling layers, the scintillation light is collected in wavelength-shifting fibers, which shift the wavelength of the light to one that can be more efficiently collected, then transported to readout electronics (\Cref{fig:megatile}), where the amount of light produced can be used to determine the energy deposited in the layer.
...
Because of these improvements, energy information from HE after the SiPM installation is segmented into 6-7 depths as shown in \Cref{fig:HElayout}.
...
A diagram of a muon interaction with a CSC chamber is shown in \Cref{fig:CSCInteraction}.
